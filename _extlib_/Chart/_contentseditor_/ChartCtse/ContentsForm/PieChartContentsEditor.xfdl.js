(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("Btn_Temp_pie","3","3","48","48",null,null,null,null,null,null,this.Popup_SeriesTemplate_Bar.form);
            obj.set_taborder("1");
            obj.getSetter("template").set("pie");
            obj.set_cssclass("btn_type06");
            this.Popup_SeriesTemplate_Bar.addChild(obj.name, obj);

            obj = new Button("Btn_Temp_donut","3","Btn_Temp_pie:3","48","48",null,null,null,null,null,null,this.Popup_SeriesTemplate_Bar.form);
            obj.set_taborder("2");
        ...
        // User Script
        this.addIncludeScript("PieChartContentsEditor.xfdl","ContentsForm::Defines.xjs");
        this.addIncludeScript("PieChartContentsEditor.xfdl","ContentsForm::UndoList.xjs");
        this.addIncludeScript("PieChartContentsEditor.xfdl","ContentsForm::UndoBuffer.xjs");
        this.addIncludeScript("PieChartContentsEditor.xfdl","ContentsForm::UndoItem.xjs");
        this.registerScript("PieChartContentsEditor.xfdl", function() {
        /* include */
        ...
        /* internal variable */
        this.module = nexacro.CTSE.Chart.PieChart;
        this.oContents = {};
        ...
        this._charttype = nexacro.CTSE.Chart.PieChartType;
        ...
        this.Popup_SeriesTemplate_Bar_onpopup = function(obj,e)
        {
        	...
        	{
        		popup_comp = popup_comps["Btn_Temp_pie"];
        	}
        ...
        this.PieEditor_onkeydown = function(obj,e)
        {
        ...
        this.PieEditor_onkeyup = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onkeydown",this.PieEditor_onkeydown,this);
            this.addEventHandler("onkeyup",this.PieEditor_onkeyup,this);
            ...
            this.Popup_SeriesTemplate_Bar.form.Btn_Temp_pie.addEventHandler("onclick",this.Popup_SeriesTemplate_Bar_Btn_onclick,this);
