(function()
{
    return function()
    {
        ...
        {
            this.set_name("RadarChartContentsEditor");
            this.set_titletext("RadarChartContentsEditor");
            ...
            obj.getSetter("classname").set("nexacro.ChartRadarCategoryAxisControl");
            obj.getSetter("index").set("-1");
            obj.getSetter("subcontrol").set("false");
            this.Area_Controls.form.Area_information.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RadarChartContentsEditor.xfdl","ContentsForm::Defines.xjs");
        this.addIncludeScript("RadarChartContentsEditor.xfdl","ContentsForm::UndoList.xjs");
        this.addIncludeScript("RadarChartContentsEditor.xfdl","ContentsForm::UndoBuffer.xjs");
        this.addIncludeScript("RadarChartContentsEditor.xfdl","ContentsForm::UndoItem.xjs");
        this.registerScript("RadarChartContentsEditor.xfdl", function() {
        /* include */
        ...
        /* internal variable */
        this.module = nexacro.CTSE.Chart.RadarChart;
        this.oContents = {};
        ...
        this._charttype = nexacro.CTSE.Chart.RadarChartType;
        	...
        	for (i in list)
        	{
        		...
        		if (contents[controlname])
        		{
        			if (controlname == "valueaxes")
        			{
        				...
        				classname = "nexacro.ChartRadarValueAxisControl"
        				parent = this.Area_Controls.form.Area_valueaxes.form;
        			}
        			else if (controlname == "seriesset")
        			{
        				singlename = "series";
        				classname = "nexacro.ChartRadarSeriesControl";
        ...
        this.RadarEditor_onkeydown = function(obj,e)
        {
        ...
        this.RadarEditor_onkeyup = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onkeydown",this.RadarEditor_onkeydown,this);
            this.addEventHandler("onkeyup",this.RadarEditor_onkeyup,this);
