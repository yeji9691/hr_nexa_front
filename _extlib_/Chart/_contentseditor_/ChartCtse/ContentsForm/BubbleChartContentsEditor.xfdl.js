(function()
{
    return function()
    {
        ...
        {
            this.set_name("BubbleChartContentsEditor");
            this.set_titletext("BubbleChartContentsEditor");
            ...
            obj = new Div("Area_information","0","Sta_infomation:0","100.00%","144",null,null,null,null,null,null,this.Area_Controls.form);
            obj.set_taborder("2");
            ...
            obj = new Button("Btn_crosshair","0","Btn_board:0","100.00%","18",null,null,null,null,null,null,this.Area_Controls.form.Area_information.form);
            obj.set_taborder("17");
            ...
            obj = new Button("Btn_crosshair_check","17","111","13","13",null,null,null,null,null,null,this.Area_Controls.form.Area_information.form);
            obj.set_taborder("18");
            obj.getSetter("subcontrol").set("true");
            obj.getSetter("is_rearrange").set("false");
            obj.getSetter("controlname").set("crosshair");
            ...
            obj = new Button("Btn_crosshair_view","158","111","13","13",null,null,null,null,null,null,this.Area_Controls.form.Area_information.form);
            obj.set_taborder("19");
            obj.getSetter("subcontrol").set("true");
            obj.getSetter("is_rearrange").set("false");
            obj.getSetter("controlname").set("crosshair");
            ...
            obj = new Button("Btn_selection_check","17","129","13","13",null,null,null,null,null,null,this.Area_Controls.form.Area_information.form);
            obj.set_taborder("21");
            obj.getSetter("subcontrol").set("true");
            obj.getSetter("is_rearrange").set("false");
            obj.getSetter("controlname").set("selection");
            ...
            obj = new Button("Btn_selection_view","158","129","13","13",null,null,null,null,null,null,this.Area_Controls.form.Area_information.form);
            obj.set_taborder("22");
            obj.getSetter("subcontrol").set("true");
            obj.getSetter("is_rearrange").set("false");
            obj.getSetter("controlname").set("selection");
            ...
            obj = new Button("Btn_removeSeries","Sta_seriesset:-23","Sta_seriesset:-20","18","18",null,null,null,null,null,null,this.Area_Controls.form);
            obj.set_taborder("10");
            obj.set_cssclass("btn_del");
            this.Area_Controls.addChild(obj.name, obj);

            obj = new Button("Btn_appenSeries",null,"Sta_seriesset:-20","18","18","Btn_removeSeries:4",null,null,null,null,null,this.Area_Controls.form);
            obj.set_taborder("11");
            obj.set_cssclass("btn_add");
            this.Area_Controls.addChild(obj.name, obj);

            obj = new Button("Btn_SeriessetColor",null,"Sta_seriesset:-21","18","18","Btn_appenSeries:4",null,null,null,null,null,this.Area_Controls.form);
            obj.set_taborder("12");
        ...
        // User Script
        this.addIncludeScript("BubbleChartContentsEditor.xfdl","ContentsForm::Defines.xjs");
        this.addIncludeScript("BubbleChartContentsEditor.xfdl","ContentsForm::UndoList.xjs");
        this.addIncludeScript("BubbleChartContentsEditor.xfdl","ContentsForm::UndoBuffer.xjs");
        this.addIncludeScript("BubbleChartContentsEditor.xfdl","ContentsForm::UndoItem.xjs");
        this.registerScript("BubbleChartContentsEditor.xfdl", function() {
        /* include */
        ...
        /* internal variable */
        this.module = nexacro.CTSE.Chart.BubbleChart;
        this.oContents = {};
        ...
        this._charttype = nexacro.CTSE.Chart.BubbleChartType;
        ...
        this.Div_Controls_Btn_appenSeries_onclick = function(obj,e)
        {
        	...
        	if (colorset)
        	{
        		...
        		expand_contents["linestyle"] = "1px solid " + colorset[coloser_idx];
        		expand_contents["fillstyle"] = colorset[coloser_idx];
        	}
        ...
        this.initChart = function ()
        {
        	...
        	// TODO : bubblechart tempdata의 생성방식
        	this.createTempData();
        ...
        this.initControlStatus = function ()
        {
        	...
        	for (i in list)
        	{
        		...
        		if (contents[controlname])
        		{
        			...
        			{
        				singlename = "series";
        				classname = "nexacro.ChartBubbleSeriesControl";
        ...
        this.createTempData = function ()
        {
        	...
        	if (ds)
        	{
        		...
        		var column_len = ds.getColCount();
        		var min_colcnt = this._min_categorycolumn + this._min_selectcolumn + this._min_valuecolumn;

        		var ret = true;
        		var category_min = 5;
        		var category_max = 100;
        		var val_min = 5;
        		var val_max = 200;
        		var temp_data_length = 10;

        		var i;
        		var idx = 0;
        		var col_idx = 0;

        		for (; column_len < min_colcnt; column_len++)
        		{
        			switch (column_len)
        			{
        				case 0:
        				case 1:
        					ds.addColumn("category" + column_len, "STRING", 256);
        					break;
        				case 2:
        					ds.addColumn("select", "STRING", 256);
        					break;
        				default:
        					ds.addColumn("value" + column_len, "FLOAT", 256);
        					break;
        			}
        		}
        		...
        		for (i = 0; i < temp_data_length; i++)
        		{
        			...
        			while(ret)
        			{
        				switch (col_idx)
        				{
        					case 0:
        					case 1:
        						ret = ds.setColumn(idx, col_idx, parseInt(Math.random() * (category_max - category_min + 1) + category_min));
        						break;
        					case 2:
        						ret = ds.setColumn(idx, col_idx, parseInt(Math.random() * 2));
        						break;
        					default:
        						ret = ds.setColumn(idx, col_idx, parseInt(Math.random() * (val_max - val_min + 1) + val_min));
        						break;
        				}
        				col_idx++;
        			}
        ...
        this.initChart_TempData = function()
        {
        	...
        	var contents_copy = nexacro.CTSE.Chart.Util.cloneContents(this.oContents);
        	var series;
        	var series_bindselectcolumn = 2;
        	var series_bindvaluecolumn = 3;
        	...
        	for (i in seriesset)
        	{
        		...
        		// valuecolumn init
        		series.valuecolumn = "bind:" + ds.getColID(0);
        ...
        this.BubbleEditor_onkeydown = function(obj,e)
        {
        ...
        this.BubbleEditor_onkeyup = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onkeydown",this.BubbleEditor_onkeydown,this);
            this.addEventHandler("onkeyup",this.BubbleEditor_onkeyup,this);
            ...
            this.Area_Controls.form.Btn_removeSeries.addEventHandler("onclick",this.Div_Controls_Btn_removeSeries_onclick,this);
            this.Area_Controls.form.Btn_appenSeries.addEventHandler("onclick",this.Div_Controls_Btn_appenSeries_onclick,this);
