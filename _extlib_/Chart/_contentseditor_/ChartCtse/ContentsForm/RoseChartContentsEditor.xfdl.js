(function()
{
    return function()
    {
        ...
        {
            this.set_name("RoseChartContentsEditor");
            this.set_titletext("RoseChartContentsEditor");
            ...
            obj._setContents("<ColumnInfo><Column id=\"category\" type=\"STRING\" size=\"256\"/><Column id=\"select\" type=\"STRING\" size=\"256\"/><Column id=\"value1\" type=\"STRING\" size=\"256\"/><Column id=\"value2\" type=\"STRING\" size=\"256\"/><Column id=\"value3\" type=\"STRING\" size=\"256\"/><Column id=\"value4\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"category\">category1</Col><Col id=\"value1\">20</Col><Col id=\"value2\">10</Col><Col id=\"value3\">40</Col><Col id=\"value4\">10</Col></Row><Row><Col id=\"category\">category2</Col><Col id=\"select\">1</Col><Col id=\"value1\">20</Col><Col id=\"value2\">40</Col><Col id=\"value3\">20</Col><Col id=\"value4\">20</Col></Row><Row><Col id=\"category\">category3</Col><Col id=\"select\">1</Col><Col id=\"value1\">30</Col><Col id=\"value2\">30</Col><Col id=\"value3\">10</Col><Col id=\"value4\">40</Col></Row><Row><Col id=\"category\">category4</Col><Col id=\"value1\">40</Col><Col id=\"value2\">20</Col><Col id=\"value3\">35</Col><Col id=\"value4\">5</Col></Row><Row><Col id=\"category\">category5</Col><Col id=\"value1\">35</Col><Col id=\"value2\">40</Col><Col id=\"value3\">20</Col><Col id=\"value4\">30</Col></Row></Rows>");
            ...
            obj.getSetter("classname").set("nexacro.ChartRoseCategoryAxisControl");
            obj.getSetter("index").set("-1");
            obj.getSetter("subcontrol").set("false");
            this.Area_Controls.form.Area_information.addChild(obj.name, obj);

            obj = new Button("Btn_categoryaxis_view","158","75","13","13",null,null,null,null,null,null,this.Area_Controls.form.Area_information.form);
            obj.set_taborder("12");
            obj.getSetter("subcontrol").set("true");
            obj.getSetter("is_rearrange").set("false");
            obj.getSetter("controlname").set("categoryaxis");
            ...
            obj = new RoseChart("Chart_Preview","210","25",null,null,"30","30",null,null,null,null,this);
            obj.set_taborder("3");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("RoseChartContentsEditor.xfdl","ContentsForm::Defines.xjs");
        this.addIncludeScript("RoseChartContentsEditor.xfdl","ContentsForm::UndoList.xjs");
        this.addIncludeScript("RoseChartContentsEditor.xfdl","ContentsForm::UndoBuffer.xjs");
        this.addIncludeScript("RoseChartContentsEditor.xfdl","ContentsForm::UndoItem.xjs");
        this.registerScript("RoseChartContentsEditor.xfdl", function() {
        /* include */
        ...
        /* internal variable */
        this.module = nexacro.CTSE.Chart.RoseChart;
        this.oContents = {};
        ...
        this._charttype = nexacro.CTSE.Chart.RoseChartType;
        ...
        this.SetSource = function (sContents)
        {
            ...
            if(addboard || addcategoryaxis || addvalueaxis)
        		{
        	...
        	for (i in list)
        	{
        		...
        		if (contents[controlname])
        		{
        			if (controlname == "valueaxes")
        			{
        				...
        				classname = "nexacro.ChartRoseValueAxisControl"
        				parent = this.Area_Controls.form.Area_valueaxes.form;
        			}
        			else if (controlname == "seriesset")
        			{
        				singlename = "series";
        				classname = "nexacro.ChartRoseSeriesControl";
        ...
        this.RoseEditor_onkeydown = function(obj,e)
        {
        ...
        this.RoseEditor_onkeyup = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onkeydown",this.RoseEditor_onkeydown,this);
            this.addEventHandler("onkeyup",this.RoseEditor_onkeyup,this);
        ...
        this.loadIncludeScript("RoseChartContentsEditor.xfdl");
